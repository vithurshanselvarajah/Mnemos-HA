...
STATE_NEVER_IDENTIFIED: Final = "no_identify_yet"
STATE_NO_MATCH: Final = "no_match"
...
EVENT_INBOX_NEW_FACE: Final = "inbox.new_face"
EVENT_INBOX_BULK_CHANGED: Final = "inbox.bulk_changed"
EVENT_WARMUP_DONE: Final = "warmup.done"
EVENT_WARMUP_ERROR: Final = "warmup.error"
EVENT_REINDEX_PROGRESS: Final = "reindex.progress"
EVENT_REINDEX_DONE: Final = "reindex.done"
